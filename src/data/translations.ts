...
export const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    home: {
      ...
      zaitonaDesc: "Zaitona represents the spirit of E.R.I.S.E. — deeply rooted in our Algerian heritage like the resilient olive tree, continuously reaching towards technological innovation, clean energy, and sustainable growth.",
      zaitonaRoots: "Roots",
      zaitonaHeritage: "Heritage & Culture",
      zaitonaGrowth: "Growth",
      zaitonaInnovation: "Innovation & Robotics",
  ...
  ar: {
    ...
    home: {
      ...
      zaitonaDesc: "تجسد «زيتونة» روح نادي E.R.I.S.E. — جذور راسخة في أصالتنا وهويتنا الجزائرية كشجرة الزيتون العريقة، وطموح يعانق الابتكار التكنولوجي والطاقات النظيفة والنمو المستدام.",
      zaitonaRoots: "الأصالة",
      zaitonaHeritage: "هوية وتراث عريق",
      zaitonaGrowth: "النمو",
      zaitonaInnovation: "ابتكار وروبوتات",
