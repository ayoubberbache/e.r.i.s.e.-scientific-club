...
export function RegistrationButton() {
  ...
  return (
    <motion.button
      ...
      className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-accent text-white font-bold text-base shadow-xl shadow-accent/25 hover:shadow-2xl hover:shadow-accent/35 transition-shadow overflow-hidden cursor-pointer"
    >
