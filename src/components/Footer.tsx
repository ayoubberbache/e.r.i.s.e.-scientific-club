  ...
  return (
    <footer className="bg-surface text-primary border-t border-subtle transition-colors pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Minimal Global Visits & Dynamically Pulled Visitor Countries */}
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            {visitorStats.countries.map((c) => (
              <div
                ...
                title={`${c.name}: ${c.count} ${language === 'ar' ? 'زيارة' : 'visits'}`}
              >
                <img
